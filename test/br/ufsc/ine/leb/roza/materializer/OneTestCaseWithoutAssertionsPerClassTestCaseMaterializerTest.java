...
public class OneTestCaseWithoutAssertionsPerClassTestCaseMaterializerTest {
	...
	void setup() {
		...
		materializer = new OneTestCaseWithoutAssertionsPerClassTestCaseMaterializer("execution/materializer");
	}
