...
public class Junit4TestClassParserTest {
	...
	private TextFile oneMethodWithFourFields;

	@BeforeEach
	void setup() {
		parser = new Junit4TestClassParser();
		oneMethod = new TextFile("OneMethod.java",
				"public class OneMethod { public void example() { System.out.println(0); } }");
		oneTestMethod = new TextFile("OneTestMethod.java",
				"public class OneTestMethod { @Test public void example() { assertEquals(0, 0); } }");
		oneTestMethodOneMethod = new TextFile("OneTestMethodOneMethod.java",
				"public class OneTestMethodOneMethod { public void example1() { System.out.println(0); } @Test public void example2() { assertEquals(2, 2); } }");
		twoTestMethods = new TextFile("TwoTestMethods.java",
				"public class TwoTestMethods { @Test public void example1() { assertEquals(1, 1); } @Test public void example2() { assertEquals(2, 2); } }");
		oneSetupMethodOneTestMethod = new TextFile("OneSetupMethodOneTestMethod.java",
				"public class OneSetupMethodOneTestMethod { @Before public void setup() { System.out.println(0); System.out.println(1); } @Test public void example() { assertEquals(0, 0); assertEquals(1, 1); } }");
		oneFieldOneSetupMethodOneTestMethod = new TextFile("OneFieldOneSetupMethodOneTestMethod.java",
				"public class OneFieldOneSetupMethodOneTestMethod { private Sut sut; @Before public void setup() { sut = new Sut(); sut.save(0); } @Test public void example() { assertEquals(0, 0); assertEquals(1, 1); } }");
		oneTestMethoWithWhile = new TextFile("OneTestMethodWithWhile.java",
				"public class OneTestMethodWithWhile { @Test public void example() { while (1 == 0) { System.out.println(0); } assertEquals(0, 0); } }");
		oneMethodWithFourFields = new TextFile("OneMethodWithFourFields.java",
				"public class OneMethodWithFourFields { private Sut sut = new Sut(); Sut sut2 = new Sut(\"data\"); Sut sut3 = new Sut(\"data\", Boolean.TRUE, sut, new Sut(sut)); Sut sut4;  @Test public void example() { } }");
	}
	...
	void oneTestMethod() throws Exception {
		...
		assertEquals("assertEquals(0, 0);",
				testClasses.get(0).getTestMethods().get(0).getStatements().get(0).getText());
	}

	@Test
	void oneTestWithThreeFields() throws Exception {
		List<TestClass> testClasses = parser.parse(Arrays.asList(oneMethodWithFourFields));
		assertEquals(1, testClasses.size());
		assertEquals("OneMethodWithFourFields", testClasses.get(0).getName());
		assertEquals(4, testClasses.get(0).getFields().size());
		assertEquals("sut", testClasses.get(0).getFields().get(0).getName());
		assertEquals("private Sut sut = new Sut();", testClasses.get(0).getFields().get(0).getText());
		assertEquals("sut2", testClasses.get(0).getFields().get(1).getName());
		assertEquals("Sut sut2 = new Sut(\"data\");", testClasses.get(0).getFields().get(1).getText());
		assertEquals("sut3", testClasses.get(0).getFields().get(2).getName());
		assertEquals("Sut sut3 = new Sut(\"data\", Boolean.TRUE, sut, new Sut(sut));", testClasses.get(0).getFields().get(2).getText());
		assertEquals("Sut sut4;", testClasses.get(0).getFields().get(3).getText());
		assertEquals(0, testClasses.get(0).getSetupMethods().size());
		assertEquals(1, testClasses.get(0).getTestMethods().size());
		assertEquals("example", testClasses.get(0).getTestMethods().get(0).getName());
		assertEquals(0, testClasses.get(0).getTestMethods().get(0).getStatements().size());
	}
	...
	void twoTestMethods() throws Exception {
		...
		assertEquals("assertEquals(2, 2);",
				testClasses.get(0).getTestMethods().get(1).getStatements().get(0).getText());
	}
	...
	void oneSetupMethodOneTestMethod() throws Exception {
		...
		assertEquals("System.out.println(0);",
				testClasses.get(0).getSetupMethods().get(0).getStatements().get(0).getText());
		assertEquals("System.out.println(1);",
				testClasses.get(0).getSetupMethods().get(0).getStatements().get(1).getText());
		assertEquals(1, testClasses.get(0).getTestMethods().size());
		assertEquals("example", testClasses.get(0).getTestMethods().get(0).getName());
		...
		assertEquals("assertEquals(0, 0);",
				testClasses.get(0).getTestMethods().get(0).getStatements().get(0).getText());
		assertEquals("assertEquals(1, 1);",
				testClasses.get(0).getTestMethods().get(0).getStatements().get(1).getText());
	}
	...
	void oneTestMethodWithWhile() throws Exception {
		...
		assertEquals("example", testClasses.get(0).getTestMethods().get(0).getName());
		assertEquals(2, testClasses.get(0).getTestMethods().get(0).getStatements().size());
		assertEquals("while (1 == 0) { System.out.println(0); }",
				testClasses.get(0).getTestMethods().get(0).getStatements().get(0).getText());
		assertEquals("assertEquals(0, 0);",
				testClasses.get(0).getTestMethods().get(0).getStatements().get(1).getText());
	}
