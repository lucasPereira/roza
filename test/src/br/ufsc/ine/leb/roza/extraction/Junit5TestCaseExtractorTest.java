...
class Junit5TestCaseExtractorTest {
	...
	void oneTestMethodWithAllAssertsOfJunit() {
		...
		Statement iterableEqualsStatement = new Statement("assertIterableEquals(List.of(1), List.of(1));");
		Statement linesMatchStatement = new Statement("assertLinesMatch(List.of(\"A\"), List.of(\"A\"));");
		...
		List<Statement> statements = List.of(equalsStatement, notEqualsStatement, trueStatement, falseStatement, nullStatement, notNullStatement, sameStatement, notSameStatement, arrayEqualsStatement, iterableEqualsStatement, linesMatchStatement, allStatement, timeoutStatement, timeoutPreemptivelyStatement, throwsStatement, doNotThrowStatement);
	...
	void oneTestMethodWithAllNonStaticAssertsOfJunit() {
		...
		Statement iterableEqualsStatement = new Statement("Assertions.assertIterableEquals(List.of(1), List.of(1));");
		Statement linesMatchStatement = new Statement("Assertions.assertLinesMatch(List.of(\"A\"), List.of(\"A\"));");
