...
public class TesteProjeto {
	...
	public void adicionarOcorrencia() {
		Ocorrencia ocorrencia = projeto.adicionarOcorrencia(1, nomeDaTarefa, TipoDeOcorrencia.TAREFA,
				PrioridadeDeOcorrencia.ALTA, responsavel);
	...
	public void obterOcorrencia() {
		Ocorrencia ocorrenciaCriada = projeto.adicionarOcorrencia(1, nomeDaTarefa, TipoDeOcorrencia.TAREFA,
				PrioridadeDeOcorrencia.ALTA, responsavel);
	...
	public void obterSegundaOcorrenciaAdicionadaDentreTres() {
		projeto.adicionarOcorrencia(1, nomeDaTarefa, TipoDeOcorrencia.TAREFA, PrioridadeDeOcorrencia.MEDIA,
				responsavel);
		Ocorrencia ocorrenciaCriada = projeto.adicionarOcorrencia(2, nomeDoBug, TipoDeOcorrencia.BUG,
				PrioridadeDeOcorrencia.ALTA, responsavel);
		projeto.adicionarOcorrencia(3, nomeDaMelhoria, TipoDeOcorrencia.MELHORIA, PrioridadeDeOcorrencia.BAIXA,
				responsavel);
	...
	public void alterarResponsavelPorOcorrenciaAberta() {
		Ocorrencia ocorrencia = projeto.adicionarOcorrencia(2, nomeDoBug, TipoDeOcorrencia.BUG,
				PrioridadeDeOcorrencia.ALTA, responsavel);
