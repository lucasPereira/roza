...
public class TesteTelaPendenciasExcecoes {
	...
	public void setUp() throws Exception {
		...
		ufsc.setMantenedora(null);
		EmTesteBanco.get(teste).atualizarEntidade(ufsc);
	...
	@Test
	public void respondidoSemMantenedora() throws Exception {
