...
public class TesteTelaRelatoriosComUmaInstituicao {
	...
	@Test
	public void umaInstituicao() throws Exception {
		...
		selenium.assertTextEquals("Universidade Federal de Santa Catarina", "form:lista:0:instituicao");
	}
