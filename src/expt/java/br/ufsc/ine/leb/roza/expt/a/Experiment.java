...
import br.ufsc.ine.leb.roza.core.retrieval.PrecisionRecall;
import br.ufsc.ine.leb.roza.core.retrieval.RecallLevel;
import br.ufsc.ine.leb.roza.core.retrieval.StandardRecallLevels;
...
import br.ufsc.ine.leb.roza.core.utils.comparator.SimilarityAssessmentComparatorByScoreSourceNameAndTargetName;
import br.ufsc.ine.leb.roza.core.utils.comparator.SimilarityAssessmentComparatorBySourceAndTargetNames;
...
public class Experiment {
	...
	private static void evaluateMeasure(String fileName, SimilarityMeasurer measurer) {
		...
		TextFileLoader loader = new RecursiveTextFileLoader("src/expt/resources/a");
