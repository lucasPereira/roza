...
public class Experiment {
	public static void main(String[] args) {
		...
		FolderUtils folderUtils = new FolderUtils("experiment-results/d");
		...
		for (int project = 1; project <= 16; project++) {
			...
			TextFileLoader loader = new RecursiveTextFileLoader("src/expt/resources/d/p" + project + "/original");
			...
			new FolderUtils("src/expt/resources/d/p" + project + "/refactored").createEmptyFolder();
			TestClassWriter writer = new Junit4TestClassWriter("src/expt/resources/d/p" + project + "/refactored");
			writer.write(refactoredClassses);

			TextFileLoader refactoredLoader = new RecursiveTextFileLoader("src/expt/resources/d/p" + project + "/refactored");
