...
public class TesteImplicit {
	...
	Agencia bbTrindade;
	Conta leandroConta;
	Conta leandroContaDepositadoDezReais;
	Conta leandroContaSaldoDezReais;
	Conta leandroContaSaldoDoisReais;
	Dinheiro doisReais;
	Dinheiro cincoReais;
	Dinheiro dezReais;
	Operacao saqueCincoReaisSaldoSuperior;
	Operacao saqueCincoReaisSaldoInferior;
