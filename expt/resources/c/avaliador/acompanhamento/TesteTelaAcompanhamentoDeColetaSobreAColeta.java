...
public class TesteTelaAcompanhamentoDeColetaSobreAColeta {
	...
	private Polo udescJaragua;
	private OfertaDisciplina programacaoSistemas2014_1;
	private Convite disciplina2014_1FabioPolo;
	...
	public void setUp() throws Exception {
		...
		EmInstituicao.get(douglas).cadastrarPolo(udescJaragua);
		...
		EmInstituicao.get(douglas).cadastrarOfertaDisciplina(programacaoSistemas2014_1);
		EmSaas.get(beatriz).sobreColeta().cadastrarColeta(disciplina2014_1);
		EmSaas.get(beatriz).sobreColeta().cadastrarConvites(Arrays.asList(disciplina2014_1JhonComputacao, disciplina2014_1FabioPolo));
	...
	@Test
	public void umConviteFocoDisciplina() throws Exception {
