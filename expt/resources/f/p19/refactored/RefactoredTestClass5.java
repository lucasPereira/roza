...
public class RefactoredTestClass5 {
	...
	public void setup() {
		...
		ocorrenciaId1 = new Ocorrencia(1, "Bug no botão 'sugestões'", Tipo.BUG, Prioridade.BAIXA, responsavelOcorrencia1);
		ocorrenciaId2 = new Ocorrencia(2, "Mudar cor de fundo da home", Tipo.MELHORIA, Prioridade.BAIXA, responsavelOcorrencia2);
		ocorrenciaId3 = new Ocorrencia(3, "Mudar formato do botão 'sugestão'", Tipo.MELHORIA, Prioridade.BAIXA, responsavelOcorrencia1);
	}
	...
	public void testCriarOcorrencia() {
		...
		Ocorrencia ocorrencia = new Ocorrencia(4, resumo, Tipo.TAREFA, Prioridade.MEDIA, responsavelOcorrencia1);
	...
	public void testOcorrenciasIguaisInstanciasDiferentes() {
		Ocorrencia ocorrenciaInstancia2 = new Ocorrencia(1, "Bug no botão 'sugestões'", Tipo.BUG, Prioridade.BAIXA, responsavelOcorrencia1);
