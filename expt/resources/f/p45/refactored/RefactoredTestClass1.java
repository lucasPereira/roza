...
public class RefactoredTestClass1 {
	...
	public void setup() {
		...
		ocorrencias[0] = new Ocorrencia(1, "Ocorrencia 1", TipoDeOcorrencia.TAREFA, PrioridadeDeOcorrencia.MEDIA, funcionario);
		ocorrencias[1] = new Ocorrencia(2, "Ocorrencia 2", TipoDeOcorrencia.TAREFA, PrioridadeDeOcorrencia.MEDIA, funcionario);
		ocorrencias[2] = new Ocorrencia(3, "Ocorrencia 3", TipoDeOcorrencia.TAREFA, PrioridadeDeOcorrencia.MEDIA, funcionario);
		ocorrencias[3] = new Ocorrencia(4, "Ocorrencia 4", TipoDeOcorrencia.TAREFA, PrioridadeDeOcorrencia.MEDIA, funcionario);
		ocorrencias[4] = new Ocorrencia(5, "Ocorrencia 5", TipoDeOcorrencia.TAREFA, PrioridadeDeOcorrencia.MEDIA, funcionario);
		ocorrencias[5] = new Ocorrencia(6, "Ocorrencia 6", TipoDeOcorrencia.TAREFA, PrioridadeDeOcorrencia.MEDIA, funcionario);
		ocorrencias[6] = new Ocorrencia(7, "Ocorrencia 7", TipoDeOcorrencia.TAREFA, PrioridadeDeOcorrencia.MEDIA, funcionario);
		ocorrencias[7] = new Ocorrencia(8, "Ocorrencia 8", TipoDeOcorrencia.TAREFA, PrioridadeDeOcorrencia.MEDIA, funcionario);
		ocorrencias[8] = new Ocorrencia(9, "Ocorrencia 9", TipoDeOcorrencia.TAREFA, PrioridadeDeOcorrencia.MEDIA, funcionario);
		ocorrencias[9] = new Ocorrencia(10, "Ocorrencia 10", TipoDeOcorrencia.TAREFA, PrioridadeDeOcorrencia.MEDIA, funcionario);
		ocorrencias[10] = new Ocorrencia(11, "Ocorrencia 11", TipoDeOcorrencia.TAREFA, PrioridadeDeOcorrencia.MEDIA, funcionario);
	}
