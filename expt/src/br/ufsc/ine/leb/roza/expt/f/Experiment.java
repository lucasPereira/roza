...
public class Experiment {
	public static void main(String[] args) {
		...
		FolderUtils folderUtils = new FolderUtils("expt/results/f");
		...
		for (int project = 1; project <= 47; project++) {
			try {
				...
				TextFileLoader loader = new RecursiveTextFileLoader("expt/resources/f/p" + project + "/original");
				...
				new FolderUtils("expt/resources/f/p" + project + "/refactored").createEmptyFolder();
				TestClassWriter writer = new Junit4TestClassWriter("expt/resources/f/p" + project + "/refactored");
				writer.write(refactoredClassses);

				TextFileLoader refactoredLoader = new RecursiveTextFileLoader("expt/resources/f/p" + project + "/refactored");
