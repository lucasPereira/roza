...
- `NonIsolatingImplicitSetupTestClassRefactorer` is implemented in `src/main/java/br/ufsc/ine/leb/roza/core/modern/refactoring` and covered by tests in `src/test/java/br/ufsc/ine/leb/roza/core/modern/refactoring`.
- `NonIsolatingImplicitSetupTestClassRefactorer` is implemented in `src/main/java/br/ufsc/ine/leb/roza/core/modern/refactoring` and covered by tests in `src/test/java/br/ufsc/ine/leb/roza/core/modern/refactoring`.
...
- 2026-08-23: Implemented `NonIsolatingImplicitSetupTestClassRefactorer` so singleton clusters are not isolated from their original classes (DEC-141).
